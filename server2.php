...
if (isset($_POST['add_classes'])) {
  // receive all input values from the form
	...
	$class4_dp = strtoupper( mysqli_real_escape_string($db, $_POST['class4_dp']));
	$class4_id = mysqli_real_escape_string($db, $_POST['class4_id']);
	$class4_prof = strtoupper(mysqli_real_escape_string($db, $_POST['class4_prof']));

	$class5_dp = strtoupper( mysqli_real_escape_string($db, $_POST['class5_dp']));
	$class5_id = mysqli_real_escape_string($db, $_POST['class5_id']);
	$class5_prof = strtoupper(mysqli_real_escape_string($db, $_POST['class5_prof']));

	$class6_dp = strtoupper( mysqli_real_escape_string($db, $_POST['class6_dp']));
	$class6_id = mysqli_real_escape_string($db, $_POST['class6_id']);
	$class6_prof = strtoupper(mysqli_real_escape_string($db, $_POST['class6_prof']));
  ...
  //CREATE CHECK FOR ERRORS HERE
    ...
    //echo "Error updating record: " . $db->error;
		...
		$sql = "UPDATE users SET c1_id = NULL WHERE id = '$student_id'";
		$db->query($sql);
	}
    ...
    //echo "Error updating record: " . $db->error;
		...
		$sql = "UPDATE users SET c2_id = NULL WHERE id = '$student_id'";
		$db->query($sql);
	}
    ...
    //echo "Error updating record: " . $db->error;
		...
		$sql = "UPDATE users SET c3_id = NULL WHERE id = '$student_id'";
		$db->query($sql);
	}
    ...
    //echo "Error updating record: " . $db->error;
		...
		$sql = "UPDATE users SET c4_id = NULL WHERE id = '$student_id'";
		$db->query($sql);
	}
    ...
    //echo "Error updating record: " . $db->error;
		...
		$sql = "UPDATE users SET c5_id = NULL WHERE id = '$student_id'";
		$db->query($sql);
	}
 ...
 //    //echo "Error updating record: " . $db->error;
	// 	}
	// }else{
	// 	$sql = "UPDATE users SET c6_id = NULL WHERE id = '$student_id'";
	// 	$db->query($sql);
	// }
